...
export default async function InvoicesPage() {
  ...
  const invoices = await Invoice.find({ userId: session!.user.id }).sort({
    createdAt: -1,
  });
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          href="/invoices/new"
          className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 lg:px-4 lg:py-2.5 rounded-xl text-sm font-medium transition-colors"
        >
          + New
        </Link>
      </div>
